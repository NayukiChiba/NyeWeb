...
-- 插入文章数据
INSERT INTO `articles` (`title`, `slug`, `category`, `date`, `summary`)
VALUES ('Logistic Regression 笔记', 'Logistic', '机器学习/分类算法', '2023-09-15',
        '本文详细介绍了逻辑回归的原理、数学推导以及在二分类问题中的应用，是机器学习入门的重要概念。'),
       ('SVM 学习笔记', 'SVM', '机器学习/分类算法', '2023-09-28',
        '支持向量机（SVM）是一种强大的分类算法。本文探讨了其核心思想，包括最大间隔、核技巧和软间隔等。'),
       ('Introduction to Python Programming', 'Introduction to Python Programming', '其他', '2023-10-05',
        '一篇面向初学者的Python入门教程，涵盖了基本语法、数据类型、控制流以及函数等核心编程概念。'),
       ('人工智能简介', '人工智能简介', '其他', '2023-10-10',
        '本文简要介绍人工智能的基本概念、发展历史、应用领域以及未来趋势，帮助读者快速了解AI技术。'),
       ('Web开发入门', 'Web开发入门', '前端', '2023-10-12',
        '本文介绍Web开发的基础知识，包括HTML、CSS和JavaScript的核心概念、简单示例以及学习资源，适合初学者快速上手。'),
       ('个人博客搭建指南', 'personal-blogging-guide', '前端', '2023-10-22',
        '本文详细介绍如何从零开始搭建个人博客，包括平台选择、域名注册、内容创作、SEO优化和流量变现等完整流程，适合初学者快速入门。'),
       ('机器学习入门与实践', 'machine-learning-introduction', '其他', '2023-10-25',
        '本文全面介绍机器学习的基本概念、常用算法、实践步骤以及Python代码示例，帮助初学者系统掌握机器学习基础并能够动手实践。'),
       ('云计算入门', 'introduction-to-cloud-computing', '其他', '2023-10-18',
        '本文介绍云计算的基本概念、主要服务提供商（如AWS和Azure）、核心服务模型以及入门实践，帮助读者快速理解云技术并开始使用。'),
       ('DevOps实践指南', 'devops-practical-guide', '其他', '2023-10-28',
        '本文深入介绍DevOps的核心概念、工具链、实践方法和完整流水线搭建，包含详细的代码示例和最佳实践，帮助团队实现高效的软件交付。'),
       ('数据科学基础', 'data-science-basics', '其他', '2023-10-15',
        '本文介绍数据科学的基本概念、常用工具（如Python和pandas）、简单数据分析示例，以及学习资源，帮助初学者快速入门。'),
       ('网络安全基础', 'cybersecurity-fundamentals', '其他', '2023-10-20',
        '本文介绍网络安全的基本概念、常见威胁类型、防护措施以及实用工具，帮助读者建立基础安全意识和防护能力。');

-- 插入项目数据
INSERT INTO `projects` (`title`, `slug`, `date`, `summary`)
VALUES ('人脸识别系统 MTCNN+FaceNet', 'FaceLogin', '2024-05-20',
       ...
       ('温度数据可视化系统', 'Visualization', '2024-04-15',
        '提供完整的温度数据可视化解决方案，支持使用Matplotlib和PyEcharts生成24种专业图表，满足从基础趋势分析到复杂三维建模的全方位需求。');

-- 插入书籍数据
INSERT INTO `books` (`title`, `description`, `filename`, `cover`)
VALUES ('C++从入门到项目实践', '一本关于Git版本控制系统的专业书籍，从基础到高级，内容全面。', 'C++从入门到项目实践',
       ...
       ('Node.js+Express+Vue.js项目开发实战', '全面深入地介绍了JavaScript语言的核心概念和最佳实践。',
        'Node.js+Express+Vue.js项目开发实战', '/avatar.jpg');

-- 插入图表数据
INSERT INTO `figures` (`title`, `description`, `filename`)
VALUES ('Web应用系统架构', '一个典型的Web应用系统架构图，展示了各组件之间的交互。', '测试1.png'),
       ('Vue 3 组件生命周期', '清晰地展示了Vue 3中组件从创建到销毁的完整生命周期钩子。', '测试2.png'),
       ('微服务通信模式', '总结了微服务架构中常见的几种服务间通信方式。', '测试3.png');

-- 插入工具数据
INSERT INTO `tools` (`title`, `description`, `url`)
VALUES ('JSON Formatter', '一个用于格式化、校验和美化JSON数据的在线工具。', 'https://jsonformatter.curiousconcept.com/'),
...
SELECT (SELECT id FROM figures WHERE filename = '测试1.png'), id
FROM tags
WHERE name IN ('架构', '后端', '系统设计');
-- Vue 3 组件生命周期
INSERT INTO `figure_tags` (figure_id, tag_id)
SELECT (SELECT id FROM figures WHERE filename = '测试2.png'), id
FROM tags
WHERE name IN ('Vue', '前端', '生命周期');
-- 微服务通信模式
INSERT INTO `figure_tags` (figure_id, tag_id)
SELECT (SELECT id FROM figures WHERE filename = '测试3.png'), id
FROM tags
...
-- 插入收藏图片数据
INSERT INTO `favorite_images` (`filename`)
VALUES ('fav1.jpg'),
       ('fav2.png'),
       ('fav3.png'),
       ('fav4.png'),
